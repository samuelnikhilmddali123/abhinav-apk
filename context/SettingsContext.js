...
function mapBackendToAppSettings(data) {
  ...
  return {
    rateModifications: {
      ...
      gold999_buy_stopped: src?.gold?.isStopped ?? false,
      silver999_buy_stopped: src?.silver?.isStopped ?? false,
      gold999_sell_stopped: src?.baseModifications?.gold999?.isStopped ?? false,
      silver999_sell_stopped: src?.baseModifications?.silver999?.isStopped ?? false,
    },
    ratesPageModifications: {
      ...
      gold24k_stopped: src?.ratesPage?.goldTable24k?.isStopped ?? false,
      gold22k_stopped: src?.ratesPage?.goldTable22k?.isStopped ?? false,
      gold18k_stopped: src?.ratesPage?.goldTable18k?.isStopped ?? false,
      gold14k_stopped: src?.ratesPage?.goldTable14k?.isStopped ?? false,
      navarsu_stopped: src?.ratesPage?.navarsuTable?.isStopped ?? false,
      silver_stopped: src?.ratesPage?.silverTable?.isStopped ?? false,
    },
    ...
    marketStatus: {
      ...
      isStoppedAll: src?.marketStatus?.isStoppedAll ?? false,
    },
